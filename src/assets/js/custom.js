...
jQuery(function($){
  ...
  /* ----------------------------------------------------------- */
    ...
    $('.mu-restaurant-menu-content ul.nav li').on('click',function (e) {
      console.log($(this));
      $('.mu-restaurant-menu-content ul.nav li.active').removeClass('active');

      var targetText = $(e.target).text();
      var elements = $('.mu-restaurant-menu-content ul.nav li');

      elements.each(function(i){
        if($(this).text()==targetText) $(this).addClass('active');
      });
    });
